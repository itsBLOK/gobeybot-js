...
module.exports = {
  ...
  async messageRun(message, args, data) {
    ...
    await message.safeReply({ embeds: [embedError] });
  },
...
async function getHelpMenu({ client, guild }) {
  ...
  const menuRow = new ActionRowBuilder().addComponents(
    new StringSelectMenuBuilder().setCustomId("help-menu").setPlaceholder("Choose the command category").addOptions(options)
  );
