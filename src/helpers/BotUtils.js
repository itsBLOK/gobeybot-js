...
module.exports = class BotUtils {
  ...
  static async checkForUpdates() {
    const response = await getJson("https://api.github.com/repos/itsblok/gobeybot-v1/releases/latest");
    ...
    if (response.data) {
      if (
        ...
        warn("download: https://github.com/itsblok/gobeybot-v1/releases/latest");
      }
    }
  }
